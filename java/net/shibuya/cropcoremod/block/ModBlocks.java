package net.shibuya.cropcoremod.block;
...
import net.shibuya.cropcoremod.block.custom.MagicBlock;
import net.shibuya.cropcoremod.block.custom.PinkGarnetLampBlock;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(Cropcoremod.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(Cropcoremod.MOD_ID, name),
                new BlockItem(block, new Item.Settings()));
    }

    public static void registerModBlock() {
        Cropcoremod.LOGGER.info("Registering Mod Blocks for " + Cropcoremod.MOD_ID);
